	  ...
	  _createClass(Slider, [{
	    ...
	    value: function drag(e) {
	      if (this.state.isDragging) {
	        var deltaX = e.clientX - this.state.dragOrigin[0];
	        var deltaY = e.clientY - this.state.dragOrigin[1];

	        var deltaPercentage = deltaX / this.props.width;
	        var newPercentage = this.state.percentage + deltaPercentage;
	    ...
	    value: function render() {
	      ...
	      var knobColor = 'hsl(' + (1 - percentage) * 128 + ', 100%, 50%)';
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('circle', { style: { fill: knobColor, stroke: 'black', strokeWidth: 1 },
	          onMouseDown: function (e) {
	            return _this2.dragStart(e);
	          },
	          r: 10 * (percentage + 0.5), cy: '21', cx: width * percentage }),
	        this.state.isDragging ? _react2['default'].createElement('rect', { style: style.backdrop, x: '-10', y: '-10', width: width + 20, height: '100' }) : null
	      );
	    }
	  }]);
